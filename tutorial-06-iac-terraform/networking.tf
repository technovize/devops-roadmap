...
# Private subnets — for application servers, databases, EKS worker nodes
...
# -- NAT Gateway ------------------------------------------------------------
# Allows private subnet resources to reach the internet (for package installs, API calls)
